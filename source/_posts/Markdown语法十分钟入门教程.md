...
**Markdown** 是一种可以使用普通文本编辑器编写的标记语言，通过简单的标记语法，它可以使普通文本内容具有一定的格式,Markdown的内镶语法（如表格、脚注、内嵌HTML等等），这些功能Markdown要么基于网站，如GitHub和Wikipedia、简书，在语法上基本兼容，但在一些语法和渲染效果上有改动.
<!--more-->
目录
================
...
[src]: https://standbyme.io/posts/b296d235.html
...
`&` 字符尤其让网络文档编写者受折磨，如果你要打「AT&T」 ，你必须要写成「`AT&amp;T`」 ，而网址中的 `&` 字符也要转换。比如你要链接到：
    ...
    https://StandByMe.io?t=1&q=standbyme.io
...
Markdown 支援在下面這些符号前面加上反斜线來帮助插入普通的符号：
